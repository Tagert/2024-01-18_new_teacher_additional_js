...
const filteredByMilesHave = cars.filter((car) => car.Miles_per_Gallon);
console.log(filteredByMilesHave);
// 1.2. Parašyti komandą kuri gražins automobilius, kurie neturi "Miles_per_Gallon" ;
const filteredByMilesNot = cars.filter((car) => !car.Miles_per_Gallon);
console.log(filteredByMilesNot);
...
const filteredByMilesCylinders = cars.filter(
  (car) => car.Cylinders === 8 && car.Miles_per_Gallon >= 15
);
console.log(filteredByMilesCylinders);
...
const allMadeInUsa = cars.every((car) => car.Origin === "USA");
const someMadeInUsa = cars.some((car) => car.Origin === "USA");
console.log(
